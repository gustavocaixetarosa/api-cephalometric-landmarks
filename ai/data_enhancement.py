...
class DataAugmentation:
    ...
    def randomCrop(image):
        ...
        random_region = (
            (image_width - crop_win_size) >> 1, (image_height -
                                                 crop_win_size) >> 1, (image_width + crop_win_size) >> 1,
...
def imageOps(func_name, image, des_path, file_name, times=5):
    ...
    for _i in range(0, times, 1):
        ...
        DataAugmentation.saveImage(new_image, os.path.join(
            des_path, func_name + str(_i) + file_name))
