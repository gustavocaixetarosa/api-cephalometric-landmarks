...
class Angle:
    ...
    def theta(self):
        theta = math.degrees(math.acos((self.va.x*self.vb.x + self.va.y*self.vb.y) / (
...
def classification(points):
    ...
    # print "4. ODI"
    ODItype = ''
    ODI = getODI(points[7], points[9], points[5], points[4],
                 points[3], points[2], points[16], points[17])
    if ODI < 68.4:
        ODItype = '3'
    elif ODI > 80.5:
        ODItype = '2'
    ...
    # print "5. APDI"
    APDItype = ''
    APDI = getAPDI(points[2], points[3], points[1], points[6], points[4],
                   points[5], points[3], points[2], points[16], points[17])
    if APDI < 77.6:
        APDItype = '2'
    elif APDI > 85.2:
        APDItype = '3'
